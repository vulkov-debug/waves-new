...
// Af22_9LRWv-fivF3wsKbPIlwLHAWX1NaY3C8QYmOE9jN3lo9EC5m5c7-xfynHvXCF4u6UmfikxGAl9V-
...
this.props.dispatch(onSuccessBuy({
  ...
  if(this.props.user.onSuccessBuy){
    this.setState({
      showTotal: false,
      showSuccess: true
    })
    ...
    return (
      <UserLayout>
        <div>
          ...
          {this.state.showTotal && (
            <div className="paypal_button_container"><Paypal 
